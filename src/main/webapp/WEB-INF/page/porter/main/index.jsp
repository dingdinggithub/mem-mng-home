...
<header id="gtco-header" class="gtco-cover" role="banner" style="background-image:url(/static/porter/images/img_bg.jpg);" data-stellar-background-ratio="0.5">
            ...
            <div class="col-md-12">
                <ul id="gtco-post-list">
                    <li class="full entry animate-box" data-animate-effect="fadeIn">
                        <a href="single.jspsingle.html">
                            <div class="entry-img" style="background-image: url('/static/porter/images/img_1_old.jpg')"></div>
                    ...
                    <li class="two-third entry animate-box" data-animate-effect="fadeIn">
                        <a href="single.jspsingle.html">
                            <div class="entry-img" style="background-image: url('/static/porter/images/img_2.jpg')"></div>
                            <div class="entry-desc">
                                <h3>How Web Hosting Can Impact Page Load Speed</h3>
                        ...
                        <a href="single.jspsingle.html" class="post-meta">Business  <span class="date-posted">4 days ago</span></a>
                    </li>
                    <li class="one-third entry animate-box" data-animate-effect="fadeIn">
                        <a href="single.jspsingle.html">
                            <div class="entry-img" style="background-image: url('/static/porter/images/img_3.jpg')"></div>
                            <div class="entry-desc">
                                <h3>How Web Hosting Can Impact Page Load Speed</h3>
                    ...
                    <li class="one-third entry animate-box" data-animate-effect="fadeIn">
                        <a href="single.jspsingle.html">
                            <div class="entry-img" style="background-image: url('/static/porter/images/img_4.jpg')"></div>
                            <div class="entry-desc">
                                <h3>How Web Hosting Can Impact Page Load Speed</h3>
                                <p>She packed her seven versalia, put her initial into the belt and made herself on the way.</p>
                            </div>
                    ...
                    <li class="one-third entry animate-box" data-animate-effect="fadeIn">
                        <a href="single.jspsingle.html">
                            <div class="entry-img" style="background-image: url('/static/porter/images/img_5.jpg')"></div>
                            <div class="entry-desc">
                                <h3>How Web Hosting Can Impact Page Load Speed</h3>
                                <p>She packed her seven versalia, put her initial into the belt and made herself on the way.</p>
                            </div>
                    ...
                    <li class="one-third entry animate-box" data-animate-effect="fadeIn">
                        <a href="single.jspsingle.html">
                            <div class="entry-img" style="background-image: url('/static/porter/images/img_6.jpg')"></div>
                            <div class="entry-desc">
                                <h3>How Web Hosting Can Impact Page Load Speed</h3>
                                <p>She packed her seven versalia, put her initial into the belt and made herself on the way.</p>
                            </div>
                    ...
                    <li class="one-half entry animate-box" data-animate-effect="fadeIn">
                        <a href="single.jspsingle.html">
                            <div class="entry-img" style="background-image: url('/static/porter/images/img_7.jpg')"></div>
                            <div class="entry-desc">
                                <h3>How Web Hosting Can Impact Page Load Speed</h3>
                                <p>She packed her seven versalia, put her initial into the belt and made herself on the way. When she reached the first hills of the Italic Mountains.</p>
                            </div>
                    ...
                    <li class="one-half entry animate-box" data-animate-effect="fadeIn">
                        <a href="single.jspsingle.html">
                            <div class="entry-img" style="background-image: url('/static/porter/images/img_8.jpg')"></div>
                            <div class="entry-desc">
                                <h3>How Web Hosting Can Impact Page Load Speed</h3>
                                <p>She packed her seven versalia, put her initial into the belt and made herself on the way. When she reached the first hills of the Italic Mountains.</p>
                            </div>
                    ...
                    <li class="one-third entry animate-box" data-animate-effect="fadeIn">
                        <a href="single.jspsingle.html">
                            <div class="entry-img" style="background-image: url('/static/porter/images/img_9.jpg')"></div>
                            <div class="entry-desc">
                                <h3>How Web Hosting Can Impact Page Load Speed</h3>
                                <p>She packed her seven versalia, put her initial into the belt and made herself on the way. When she reached the first hills of the Italic Mountains.</p>
                            </div>
                    ...
                    <li class="two-third entry animate-box" data-animate-effect="fadeIn">
                        <a href="single.jspsingle.html">
                            <div class="entry-img" style="background-image: url('/static/porter/images/img_10.jpg')"></div>
                            <div class="entry-desc">
                                <h3>How Web Hosting Can Impact Page Load Speed</h3>
                                <p>She packed her seven versalia, put her initial into the belt and made herself on the way. When she reached the first hills of the Italic Mountains.</p>
                            </div>
